...
port (
    ...
    FR : OUT STD_LOGIC_VECTOR (63 downto 0);
    FR_ap_vld : OUT STD_LOGIC;
...
architecture behav of estimate_FR is 
    ...
    "estimate_FR,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.621000,HLS_SYN_LAT=28,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=14,HLS_SYN_FF=4808,HLS_SYN_LUT=6999,HLS_VERSION=2019_1}";
    ...
    signal finish_read_read_fu_60_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal finish_read_reg_269 : STD_LOGIC_VECTOR (0 downto 0);
    signal c_read_reg_273 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln8_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln8_reg_279 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal icmp_ln8_1_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln8_1_reg_284 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln8_1_fu_206_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln8_1_reg_289 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state14 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state14 : signal is "none";
    signal add_ln8_fu_212_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln8_reg_293 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln8_4_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln8_4_reg_298 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state27 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state27 : signal is "none";
    signal icmp_ln8_5_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln8_5_reg_303 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln8_2_fu_251_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln8_2_reg_308 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal bitcast_ln8_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_2_fu_135_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln8_fu_145_p1 : STD_LOGIC_VECTOR (51 downto 0);
    signal bitcast_ln8_1_fu_161_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_fu_164_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln8_1_fu_174_p1 : STD_LOGIC_VECTOR (51 downto 0);
    signal icmp_ln8_3_fu_188_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln8_2_fu_182_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln8_fu_178_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln8_1_fu_194_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln8_fu_200_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal bitcast_ln8_2_fu_217_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_8_fu_221_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln8_2_fu_231_p1 : STD_LOGIC_VECTOR (51 downto 0);
    signal or_ln8_2_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_113_opcode : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (61 downto 0);

    component estimate_FR_dadd_64ns_64ns_64_5_full_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    estimate_FR_dadd_64ns_64ns_64_5_full_dsp_1_U1 : component estimate_FR_dadd_64ns_64ns_64_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    estimate_FR_sitodp_32ns_64_6_1_U5 : component estimate_FR_sitodp_32ns_64_6_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state14) and (ap_const_lv1_1 = and_ln8_1_fu_206_p2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                c_read_reg_273 <= c_i;
                finish_read_reg_269 <= (0=>finish_i, others=>'-');
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, finish_read_read_fu_60_p2, and_ln8_1_fu_206_p2, ap_CS_fsm_state14, and_ln8_2_fu_251_p2, ap_CS_fsm_state28)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (finish_read_read_fu_60_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state33;
                elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (finish_read_read_fu_60_p2 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_state14 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state14) and (ap_const_lv1_0 = and_ln8_1_fu_206_p2))) then
            ...
            when ap_ST_fsm_state28 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state28) and (ap_const_lv1_0 = and_ln8_2_fu_251_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state32;
                else
    ...
    FR_ap_vld_assign_proc : process(ap_CS_fsm_state62)
    begin
    ...
    add_ln8_fu_212_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(Num));
    and_ln8_1_fu_206_p2 <= (grp_fu_113_p2 and and_ln8_fu_200_p2);
    and_ln8_2_fu_251_p2 <= (or_ln8_2_fu_247_p2 and grp_fu_113_p2);
    and_ln8_fu_200_p2 <= (or_ln8_fu_178_p2 and or_ln8_1_fu_194_p2);
    ...
    bitcast_ln8_1_fu_161_p1 <= spksTime;
    bitcast_ln8_2_fu_217_p1 <= reg_126;
    bitcast_ln8_fu_131_p1 <= reg_126;

    c_o_assign_proc : process(c_i, finish_read_reg_269, and_ln8_1_reg_289, and_ln8_2_reg_308, grp_fu_95_p2, ap_CS_fsm_state32, ap_CS_fsm_state62)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state62)) then 
            c_o <= ap_const_lv64_0;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state32) and (ap_const_lv1_1 = and_ln8_2_reg_308) and (ap_const_lv1_1 = and_ln8_1_reg_289) and (finish_read_reg_269 = ap_const_lv1_0))) then 
            c_o <= grp_fu_95_p2;
        else 
            c_o <= c_i;
        end if; 
    ...
    c_o_ap_vld_assign_proc : process(finish_read_reg_269, and_ln8_1_reg_289, and_ln8_2_reg_308, ap_CS_fsm_state32, ap_CS_fsm_state62)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state62) or ((ap_const_logic_1 = ap_CS_fsm_state32) and (ap_const_lv1_1 = and_ln8_2_reg_308) and (ap_const_lv1_1 = and_ln8_1_reg_289) and (finish_read_reg_269 = ap_const_lv1_0)))) then 
    ...
    finish_o_assign_proc : process(finish_i, ap_CS_fsm_state62)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state62)) then 
    ...
    finish_o_ap_vld_assign_proc : process(ap_CS_fsm_state62)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state62)) then 
    ...
    finish_read_read_fu_60_p2 <= (0=>finish_i, others=>'-');

    grp_fu_113_opcode_assign_proc : process(ap_CS_fsm_state13, ap_CS_fsm_state27)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state27)) then 
    ...
    grp_fu_117_p0_assign_proc : process(ap_CS_fsm_state1, Num, add_ln8_reg_293, ap_CS_fsm_state15)
    begin
    ...
    icmp_ln8_1_fu_155_p2 <= "1" when (trunc_ln8_fu_145_p1 = ap_const_lv52_0) else "0";
    icmp_ln8_2_fu_182_p2 <= "0" when (tmp_5_fu_164_p4 = ap_const_lv11_7FF) else "1";
    icmp_ln8_3_fu_188_p2 <= "1" when (trunc_ln8_1_fu_174_p1 = ap_const_lv52_0) else "0";
    icmp_ln8_4_fu_235_p2 <= "0" when (tmp_8_fu_221_p4 = ap_const_lv11_7FF) else "1";
    icmp_ln8_5_fu_241_p2 <= "1" when (trunc_ln8_2_fu_231_p1 = ap_const_lv52_0) else "0";
    icmp_ln8_fu_149_p2 <= "0" when (tmp_2_fu_135_p4 = ap_const_lv11_7FF) else "1";
    or_ln8_1_fu_194_p2 <= (icmp_ln8_3_fu_188_p2 or icmp_ln8_2_fu_182_p2);
    or_ln8_2_fu_247_p2 <= (icmp_ln8_5_reg_303 or icmp_ln8_4_reg_298);
    or_ln8_fu_178_p2 <= (icmp_ln8_reg_279 or icmp_ln8_1_reg_284);
    tmp_2_fu_135_p4 <= bitcast_ln8_fu_131_p1(62 downto 52);
    tmp_5_fu_164_p4 <= bitcast_ln8_1_fu_161_p1(62 downto 52);
    tmp_8_fu_221_p4 <= bitcast_ln8_2_fu_217_p1(62 downto 52);
    trunc_ln8_1_fu_174_p1 <= bitcast_ln8_1_fu_161_p1(52 - 1 downto 0);
    trunc_ln8_2_fu_231_p1 <= bitcast_ln8_2_fu_217_p1(52 - 1 downto 0);
    trunc_ln8_fu_145_p1 <= bitcast_ln8_fu_131_p1(52 - 1 downto 0);
end behav;
