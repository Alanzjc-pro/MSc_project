...
set Library     "hls"
set IPName      "estimate_ISI"
set Version     "1.0"
set DisplayName "Estimate_isi"
set Revision    "2107261607"
...
set sdx_kernel_name "estimate_ISI"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/e2/Documents/Vivado_hls/ISI_MUL_FIX_v4/original"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_ISI_ISI_V
...
## Variables
set Top "estimate_ISI"
set TopNoPrefix "estimate_ISI"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "inputs {base_address 512 range 512} rem_r {base_address 1024 range 512} output_r {base_address 1536 range 128}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 386 II x}
