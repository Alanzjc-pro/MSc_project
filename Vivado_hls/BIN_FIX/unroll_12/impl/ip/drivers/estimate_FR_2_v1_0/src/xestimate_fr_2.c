...
u32 XEstimate_fr_2_Get_counts_8_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE);
}

u32 XEstimate_fr_2_Get_counts_8_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_HIGH);
}

u32 XEstimate_fr_2_Get_counts_8_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + 1);
}

u32 XEstimate_fr_2_Get_counts_8_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_COUNTS_8;
}

u32 XEstimate_fr_2_Get_counts_8_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_COUNTS_8;
}

u32 XEstimate_fr_2_Write_counts_8_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_8_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_counts_8_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_8_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_8_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_counts_9_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE);
}

u32 XEstimate_fr_2_Get_counts_9_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_HIGH);
}

u32 XEstimate_fr_2_Get_counts_9_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + 1);
}

u32 XEstimate_fr_2_Get_counts_9_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_COUNTS_9;
}

u32 XEstimate_fr_2_Get_counts_9_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_COUNTS_9;
}

u32 XEstimate_fr_2_Write_counts_9_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_9_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_counts_9_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_9_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_9_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_counts_10_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE);
}

u32 XEstimate_fr_2_Get_counts_10_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_HIGH);
}

u32 XEstimate_fr_2_Get_counts_10_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + 1);
}

u32 XEstimate_fr_2_Get_counts_10_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_COUNTS_10;
}

u32 XEstimate_fr_2_Get_counts_10_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_COUNTS_10;
}

u32 XEstimate_fr_2_Write_counts_10_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_10_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_counts_10_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_10_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_10_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_counts_11_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE);
}

u32 XEstimate_fr_2_Get_counts_11_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_HIGH);
}

u32 XEstimate_fr_2_Get_counts_11_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + 1);
}

u32 XEstimate_fr_2_Get_counts_11_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_COUNTS_11;
}

u32 XEstimate_fr_2_Get_counts_11_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_COUNTS_11;
}

u32 XEstimate_fr_2_Write_counts_11_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_11_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_counts_11_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_counts_11_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_COUNTS_11_BASE + offset + i);
    }
    return length;
}
...
u32 XEstimate_fr_2_Get_outputs_8_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE);
}

u32 XEstimate_fr_2_Get_outputs_8_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_HIGH);
}

u32 XEstimate_fr_2_Get_outputs_8_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + 1);
}

u32 XEstimate_fr_2_Get_outputs_8_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_OUTPUTS_8;
}

u32 XEstimate_fr_2_Get_outputs_8_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_OUTPUTS_8;
}

u32 XEstimate_fr_2_Write_outputs_8_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_8_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_outputs_8_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_8_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_8_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_outputs_9_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE);
}

u32 XEstimate_fr_2_Get_outputs_9_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_HIGH);
}

u32 XEstimate_fr_2_Get_outputs_9_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + 1);
}

u32 XEstimate_fr_2_Get_outputs_9_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_OUTPUTS_9;
}

u32 XEstimate_fr_2_Get_outputs_9_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_OUTPUTS_9;
}

u32 XEstimate_fr_2_Write_outputs_9_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_9_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_outputs_9_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_9_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_9_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_outputs_10_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE);
}

u32 XEstimate_fr_2_Get_outputs_10_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_HIGH);
}

u32 XEstimate_fr_2_Get_outputs_10_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + 1);
}

u32 XEstimate_fr_2_Get_outputs_10_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_OUTPUTS_10;
}

u32 XEstimate_fr_2_Get_outputs_10_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_OUTPUTS_10;
}

u32 XEstimate_fr_2_Write_outputs_10_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_10_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_outputs_10_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_10_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_10_BASE + offset + i);
    }
    return length;
}

u32 XEstimate_fr_2_Get_outputs_11_BaseAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE);
}

u32 XEstimate_fr_2_Get_outputs_11_HighAddress(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_HIGH);
}

u32 XEstimate_fr_2_Get_outputs_11_TotalBytes(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + 1);
}

u32 XEstimate_fr_2_Get_outputs_11_BitWidth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_WIDTH_OUTPUTS_11;
}

u32 XEstimate_fr_2_Get_outputs_11_Depth(XEstimate_fr_2 *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XESTIMATE_FR_2_AXILITES_DEPTH_OUTPUTS_11;
}

u32 XEstimate_fr_2_Write_outputs_11_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_11_Words(XEstimate_fr_2 *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + (offset + i)*4);
    }
    return length;
}

u32 XEstimate_fr_2_Write_outputs_11_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_HIGH - XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XEstimate_fr_2_Read_outputs_11_Bytes(XEstimate_fr_2 *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XESTIMATE_FR_2_AXILITES_ADDR_OUTPUTS_11_BASE + offset + i);
    }
    return length;
}
