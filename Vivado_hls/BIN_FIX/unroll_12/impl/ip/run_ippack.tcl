...
set solution_dir "/home/e2/Documents/BIN/unroll_12"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_FR_2_cnt_0_V
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "inputs_0 {base_address 32 range 32} inputs_1 {base_address 64 range 32} inputs_2 {base_address 96 range 32} inputs_3 {base_address 128 range 32} inputs_4 {base_address 160 range 32} inputs_5 {base_address 192 range 32} inputs_6 {base_address 224 range 32} inputs_7 {base_address 256 range 32} inputs_8 {base_address 288 range 32} inputs_9 {base_address 320 range 32} inputs_10 {base_address 352 range 32} inputs_11 {base_address 384 range 32} counts_0 {base_address 416 range 8} counts_1 {base_address 424 range 8} counts_2 {base_address 432 range 8} counts_3 {base_address 440 range 8} counts_4 {base_address 448 range 8} counts_5 {base_address 456 range 8} counts_6 {base_address 464 range 8} counts_7 {base_address 472 range 8} counts_8 {base_address 480 range 8} counts_9 {base_address 488 range 8} counts_10 {base_address 496 range 8} counts_11 {base_address 504 range 8} outputs_0 {base_address 512 range 8} outputs_1 {base_address 520 range 8} outputs_2 {base_address 528 range 8} outputs_3 {base_address 536 range 8} outputs_4 {base_address 544 range 8} outputs_5 {base_address 552 range 8} outputs_6 {base_address 560 range 8} outputs_7 {base_address 568 range 8} outputs_8 {base_address 576 range 8} outputs_9 {base_address 584 range 8} outputs_10 {base_address 592 range 8} outputs_11 {base_address 600 range 8}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
