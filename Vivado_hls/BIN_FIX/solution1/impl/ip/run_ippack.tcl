...
set solution_dir "/home/e2/Documents/BIN/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_FR_2_cnt_V
estimate_FR_2_FR_V
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "inputs {base_address 512 range 512} counts {base_address 1024 range 128} outputs {base_address 1152 range 128}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 555 II x}
