...
architecture behave of estimate_FR_2_AXILiteS_s_axi is
    ...
    constant ADDR_INPUTS_0_BASE  : INTEGER := 16#100#;
    constant ADDR_INPUTS_0_HIGH  : INTEGER := 16#1ff#;
    constant ADDR_INPUTS_1_BASE  : INTEGER := 16#200#;
    constant ADDR_INPUTS_1_HIGH  : INTEGER := 16#2ff#;
    constant ADDR_COUNTS_0_BASE  : INTEGER := 16#300#;
    constant ADDR_COUNTS_0_HIGH  : INTEGER := 16#33f#;
    constant ADDR_COUNTS_1_BASE  : INTEGER := 16#340#;
    constant ADDR_COUNTS_1_HIGH  : INTEGER := 16#37f#;
    constant ADDR_OUTPUTS_0_BASE : INTEGER := 16#380#;
    constant ADDR_OUTPUTS_0_HIGH : INTEGER := 16#3bf#;
    constant ADDR_OUTPUTS_1_BASE : INTEGER := 16#3c0#;
    constant ADDR_OUTPUTS_1_HIGH : INTEGER := 16#3ff#;
    ...
    -- memory signals
    signal int_inputs_0_address0 : UNSIGNED(5 downto 0);
    ...
    signal int_inputs_0_address1 : UNSIGNED(5 downto 0);
    ...
    signal int_inputs_1_address0 : UNSIGNED(5 downto 0);
    ...
    signal int_inputs_1_address1 : UNSIGNED(5 downto 0);
    ...
    signal int_counts_0_address0 : UNSIGNED(3 downto 0);
    ...
    signal int_counts_0_address1 : UNSIGNED(3 downto 0);
    ...
    signal int_counts_1_address0 : UNSIGNED(3 downto 0);
    ...
    signal int_counts_1_address1 : UNSIGNED(3 downto 0);
    ...
    signal int_outputs_0_address0 : UNSIGNED(3 downto 0);
    ...
    signal int_outputs_0_address1 : UNSIGNED(3 downto 0);
    ...
    signal int_outputs_1_address0 : UNSIGNED(3 downto 0);
    ...
    signal int_outputs_1_address1 : UNSIGNED(3 downto 0);
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_inputs_0_read = '0') and (int_inputs_1_read = '0') and (int_counts_0_read = '0') and (int_counts_1_read = '0') and (int_outputs_0_read = '0') and (int_outputs_1_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_inputs_0_address1 <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_inputs_1_address1 <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_counts_0_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_counts_1_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_outputs_0_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_outputs_1_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
