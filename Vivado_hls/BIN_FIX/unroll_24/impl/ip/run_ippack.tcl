...
set Library     "hls"
set IPName      "estimate_FR_2"
set Version     "1.0"
set DisplayName "Estimate_fr_2"
set Revision    "2108181546"
...
set sdx_kernel_name "estimate_FR_2"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/e2/Documents/BIN/unroll_24"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_FR_2_mux_42_6_1_1
...
## Variables
set Top "estimate_FR_2"
set TopNoPrefix "estimate_FR_2"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x190 counts_0_i W 0x0 "Data signal of counts_0_i" {{0 32 counts_0_i W 0 "Bit 31 to 0 Data signal of counts_0_i"}}} {0x198 counts_0_o R 0x0 "Data signal of counts_0_o" {{0 32 counts_0_o R 0 "Bit 31 to 0 Data signal of counts_0_o"}}} {0x19c counts_0_o_ctrl R 0x0 "Control signal of counts_0_o" {{0 1 counts_0_o_ap_vld R 0 "Control signal counts_0_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1a0 counts_1_i W 0x0 "Data signal of counts_1_i" {{0 32 counts_1_i W 0 "Bit 31 to 0 Data signal of counts_1_i"}}} {0x1a8 counts_1_o R 0x0 "Data signal of counts_1_o" {{0 32 counts_1_o R 0 "Bit 31 to 0 Data signal of counts_1_o"}}} {0x1ac counts_1_o_ctrl R 0x0 "Control signal of counts_1_o" {{0 1 counts_1_o_ap_vld R 0 "Control signal counts_1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1b0 counts_2_i W 0x0 "Data signal of counts_2_i" {{0 32 counts_2_i W 0 "Bit 31 to 0 Data signal of counts_2_i"}}} {0x1b8 counts_2_o R 0x0 "Data signal of counts_2_o" {{0 32 counts_2_o R 0 "Bit 31 to 0 Data signal of counts_2_o"}}} {0x1bc counts_2_o_ctrl R 0x0 "Control signal of counts_2_o" {{0 1 counts_2_o_ap_vld R 0 "Control signal counts_2_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c0 counts_3_i W 0x0 "Data signal of counts_3_i" {{0 32 counts_3_i W 0 "Bit 31 to 0 Data signal of counts_3_i"}}} {0x1c8 counts_3_o R 0x0 "Data signal of counts_3_o" {{0 32 counts_3_o R 0 "Bit 31 to 0 Data signal of counts_3_o"}}} {0x1cc counts_3_o_ctrl R 0x0 "Control signal of counts_3_o" {{0 1 counts_3_o_ap_vld R 0 "Control signal counts_3_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1d0 counts_4_i W 0x0 "Data signal of counts_4_i" {{0 32 counts_4_i W 0 "Bit 31 to 0 Data signal of counts_4_i"}}} {0x1d8 counts_4_o R 0x0 "Data signal of counts_4_o" {{0 32 counts_4_o R 0 "Bit 31 to 0 Data signal of counts_4_o"}}} {0x1dc counts_4_o_ctrl R 0x0 "Control signal of counts_4_o" {{0 1 counts_4_o_ap_vld R 0 "Control signal counts_4_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1e0 counts_5_i W 0x0 "Data signal of counts_5_i" {{0 32 counts_5_i W 0 "Bit 31 to 0 Data signal of counts_5_i"}}} {0x1e8 counts_5_o R 0x0 "Data signal of counts_5_o" {{0 32 counts_5_o R 0 "Bit 31 to 0 Data signal of counts_5_o"}}} {0x1ec counts_5_o_ctrl R 0x0 "Control signal of counts_5_o" {{0 1 counts_5_o_ap_vld R 0 "Control signal counts_5_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1f0 counts_6_i W 0x0 "Data signal of counts_6_i" {{0 32 counts_6_i W 0 "Bit 31 to 0 Data signal of counts_6_i"}}} {0x1f8 counts_6_o R 0x0 "Data signal of counts_6_o" {{0 32 counts_6_o R 0 "Bit 31 to 0 Data signal of counts_6_o"}}} {0x1fc counts_6_o_ctrl R 0x0 "Control signal of counts_6_o" {{0 1 counts_6_o_ap_vld R 0 "Control signal counts_6_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x200 counts_7_i W 0x0 "Data signal of counts_7_i" {{0 32 counts_7_i W 0 "Bit 31 to 0 Data signal of counts_7_i"}}} {0x208 counts_7_o R 0x0 "Data signal of counts_7_o" {{0 32 counts_7_o R 0 "Bit 31 to 0 Data signal of counts_7_o"}}} {0x20c counts_7_o_ctrl R 0x0 "Control signal of counts_7_o" {{0 1 counts_7_o_ap_vld R 0 "Control signal counts_7_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x210 counts_8_i W 0x0 "Data signal of counts_8_i" {{0 32 counts_8_i W 0 "Bit 31 to 0 Data signal of counts_8_i"}}} {0x218 counts_8_o R 0x0 "Data signal of counts_8_o" {{0 32 counts_8_o R 0 "Bit 31 to 0 Data signal of counts_8_o"}}} {0x21c counts_8_o_ctrl R 0x0 "Control signal of counts_8_o" {{0 1 counts_8_o_ap_vld R 0 "Control signal counts_8_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x220 counts_9_i W 0x0 "Data signal of counts_9_i" {{0 32 counts_9_i W 0 "Bit 31 to 0 Data signal of counts_9_i"}}} {0x228 counts_9_o R 0x0 "Data signal of counts_9_o" {{0 32 counts_9_o R 0 "Bit 31 to 0 Data signal of counts_9_o"}}} {0x22c counts_9_o_ctrl R 0x0 "Control signal of counts_9_o" {{0 1 counts_9_o_ap_vld R 0 "Control signal counts_9_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x230 counts_10_i W 0x0 "Data signal of counts_10_i" {{0 32 counts_10_i W 0 "Bit 31 to 0 Data signal of counts_10_i"}}} {0x238 counts_10_o R 0x0 "Data signal of counts_10_o" {{0 32 counts_10_o R 0 "Bit 31 to 0 Data signal of counts_10_o"}}} {0x23c counts_10_o_ctrl R 0x0 "Control signal of counts_10_o" {{0 1 counts_10_o_ap_vld R 0 "Control signal counts_10_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x240 counts_11_i W 0x0 "Data signal of counts_11_i" {{0 32 counts_11_i W 0 "Bit 31 to 0 Data signal of counts_11_i"}}} {0x248 counts_11_o R 0x0 "Data signal of counts_11_o" {{0 32 counts_11_o R 0 "Bit 31 to 0 Data signal of counts_11_o"}}} {0x24c counts_11_o_ctrl R 0x0 "Control signal of counts_11_o" {{0 1 counts_11_o_ap_vld R 0 "Control signal counts_11_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x250 counts_12_i W 0x0 "Data signal of counts_12_i" {{0 32 counts_12_i W 0 "Bit 31 to 0 Data signal of counts_12_i"}}} {0x258 counts_12_o R 0x0 "Data signal of counts_12_o" {{0 32 counts_12_o R 0 "Bit 31 to 0 Data signal of counts_12_o"}}} {0x25c counts_12_o_ctrl R 0x0 "Control signal of counts_12_o" {{0 1 counts_12_o_ap_vld R 0 "Control signal counts_12_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x260 counts_13_i W 0x0 "Data signal of counts_13_i" {{0 32 counts_13_i W 0 "Bit 31 to 0 Data signal of counts_13_i"}}} {0x268 counts_13_o R 0x0 "Data signal of counts_13_o" {{0 32 counts_13_o R 0 "Bit 31 to 0 Data signal of counts_13_o"}}} {0x26c counts_13_o_ctrl R 0x0 "Control signal of counts_13_o" {{0 1 counts_13_o_ap_vld R 0 "Control signal counts_13_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x270 counts_14_i W 0x0 "Data signal of counts_14_i" {{0 32 counts_14_i W 0 "Bit 31 to 0 Data signal of counts_14_i"}}} {0x278 counts_14_o R 0x0 "Data signal of counts_14_o" {{0 32 counts_14_o R 0 "Bit 31 to 0 Data signal of counts_14_o"}}} {0x27c counts_14_o_ctrl R 0x0 "Control signal of counts_14_o" {{0 1 counts_14_o_ap_vld R 0 "Control signal counts_14_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x280 counts_15_i W 0x0 "Data signal of counts_15_i" {{0 32 counts_15_i W 0 "Bit 31 to 0 Data signal of counts_15_i"}}} {0x288 counts_15_o R 0x0 "Data signal of counts_15_o" {{0 32 counts_15_o R 0 "Bit 31 to 0 Data signal of counts_15_o"}}} {0x28c counts_15_o_ctrl R 0x0 "Control signal of counts_15_o" {{0 1 counts_15_o_ap_vld R 0 "Control signal counts_15_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x290 counts_16_i W 0x0 "Data signal of counts_16_i" {{0 32 counts_16_i W 0 "Bit 31 to 0 Data signal of counts_16_i"}}} {0x298 counts_16_o R 0x0 "Data signal of counts_16_o" {{0 32 counts_16_o R 0 "Bit 31 to 0 Data signal of counts_16_o"}}} {0x29c counts_16_o_ctrl R 0x0 "Control signal of counts_16_o" {{0 1 counts_16_o_ap_vld R 0 "Control signal counts_16_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2a0 counts_17_i W 0x0 "Data signal of counts_17_i" {{0 32 counts_17_i W 0 "Bit 31 to 0 Data signal of counts_17_i"}}} {0x2a8 counts_17_o R 0x0 "Data signal of counts_17_o" {{0 32 counts_17_o R 0 "Bit 31 to 0 Data signal of counts_17_o"}}} {0x2ac counts_17_o_ctrl R 0x0 "Control signal of counts_17_o" {{0 1 counts_17_o_ap_vld R 0 "Control signal counts_17_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2b0 counts_18_i W 0x0 "Data signal of counts_18_i" {{0 32 counts_18_i W 0 "Bit 31 to 0 Data signal of counts_18_i"}}} {0x2b8 counts_18_o R 0x0 "Data signal of counts_18_o" {{0 32 counts_18_o R 0 "Bit 31 to 0 Data signal of counts_18_o"}}} {0x2bc counts_18_o_ctrl R 0x0 "Control signal of counts_18_o" {{0 1 counts_18_o_ap_vld R 0 "Control signal counts_18_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2c0 counts_19_i W 0x0 "Data signal of counts_19_i" {{0 32 counts_19_i W 0 "Bit 31 to 0 Data signal of counts_19_i"}}} {0x2c8 counts_19_o R 0x0 "Data signal of counts_19_o" {{0 32 counts_19_o R 0 "Bit 31 to 0 Data signal of counts_19_o"}}} {0x2cc counts_19_o_ctrl R 0x0 "Control signal of counts_19_o" {{0 1 counts_19_o_ap_vld R 0 "Control signal counts_19_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2d0 counts_20_i W 0x0 "Data signal of counts_20_i" {{0 32 counts_20_i W 0 "Bit 31 to 0 Data signal of counts_20_i"}}} {0x2d8 counts_20_o R 0x0 "Data signal of counts_20_o" {{0 32 counts_20_o R 0 "Bit 31 to 0 Data signal of counts_20_o"}}} {0x2dc counts_20_o_ctrl R 0x0 "Control signal of counts_20_o" {{0 1 counts_20_o_ap_vld R 0 "Control signal counts_20_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2e0 counts_21_i W 0x0 "Data signal of counts_21_i" {{0 32 counts_21_i W 0 "Bit 31 to 0 Data signal of counts_21_i"}}} {0x2e8 counts_21_o R 0x0 "Data signal of counts_21_o" {{0 32 counts_21_o R 0 "Bit 31 to 0 Data signal of counts_21_o"}}} {0x2ec counts_21_o_ctrl R 0x0 "Control signal of counts_21_o" {{0 1 counts_21_o_ap_vld R 0 "Control signal counts_21_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x2f0 counts_22_i W 0x0 "Data signal of counts_22_i" {{0 32 counts_22_i W 0 "Bit 31 to 0 Data signal of counts_22_i"}}} {0x2f8 counts_22_o R 0x0 "Data signal of counts_22_o" {{0 32 counts_22_o R 0 "Bit 31 to 0 Data signal of counts_22_o"}}} {0x2fc counts_22_o_ctrl R 0x0 "Control signal of counts_22_o" {{0 1 counts_22_o_ap_vld R 0 "Control signal counts_22_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x300 counts_23_i W 0x0 "Data signal of counts_23_i" {{0 32 counts_23_i W 0 "Bit 31 to 0 Data signal of counts_23_i"}}} {0x308 counts_23_o R 0x0 "Data signal of counts_23_o" {{0 32 counts_23_o R 0 "Bit 31 to 0 Data signal of counts_23_o"}}} {0x30c counts_23_o_ctrl R 0x0 "Control signal of counts_23_o" {{0 1 counts_23_o_ap_vld R 0 "Control signal counts_23_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x310 outputs_0 R 0x0 "Data signal of outputs_0" {{0 32 outputs_0 R 0 "Bit 31 to 0 Data signal of outputs_0"}}} {0x314 outputs_0_ctrl R 0x0 "Control signal of outputs_0" {{0 1 outputs_0_ap_vld R 0 "Control signal outputs_0_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x318 outputs_1 R 0x0 "Data signal of outputs_1" {{0 32 outputs_1 R 0 "Bit 31 to 0 Data signal of outputs_1"}}} {0x31c outputs_1_ctrl R 0x0 "Control signal of outputs_1" {{0 1 outputs_1_ap_vld R 0 "Control signal outputs_1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x320 outputs_2 R 0x0 "Data signal of outputs_2" {{0 32 outputs_2 R 0 "Bit 31 to 0 Data signal of outputs_2"}}} {0x324 outputs_2_ctrl R 0x0 "Control signal of outputs_2" {{0 1 outputs_2_ap_vld R 0 "Control signal outputs_2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x328 outputs_3 R 0x0 "Data signal of outputs_3" {{0 32 outputs_3 R 0 "Bit 31 to 0 Data signal of outputs_3"}}} {0x32c outputs_3_ctrl R 0x0 "Control signal of outputs_3" {{0 1 outputs_3_ap_vld R 0 "Control signal outputs_3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x330 outputs_4 R 0x0 "Data signal of outputs_4" {{0 32 outputs_4 R 0 "Bit 31 to 0 Data signal of outputs_4"}}} {0x334 outputs_4_ctrl R 0x0 "Control signal of outputs_4" {{0 1 outputs_4_ap_vld R 0 "Control signal outputs_4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x338 outputs_5 R 0x0 "Data signal of outputs_5" {{0 32 outputs_5 R 0 "Bit 31 to 0 Data signal of outputs_5"}}} {0x33c outputs_5_ctrl R 0x0 "Control signal of outputs_5" {{0 1 outputs_5_ap_vld R 0 "Control signal outputs_5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x340 outputs_6 R 0x0 "Data signal of outputs_6" {{0 32 outputs_6 R 0 "Bit 31 to 0 Data signal of outputs_6"}}} {0x344 outputs_6_ctrl R 0x0 "Control signal of outputs_6" {{0 1 outputs_6_ap_vld R 0 "Control signal outputs_6_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x348 outputs_7 R 0x0 "Data signal of outputs_7" {{0 32 outputs_7 R 0 "Bit 31 to 0 Data signal of outputs_7"}}} {0x34c outputs_7_ctrl R 0x0 "Control signal of outputs_7" {{0 1 outputs_7_ap_vld R 0 "Control signal outputs_7_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x350 outputs_8 R 0x0 "Data signal of outputs_8" {{0 32 outputs_8 R 0 "Bit 31 to 0 Data signal of outputs_8"}}} {0x354 outputs_8_ctrl R 0x0 "Control signal of outputs_8" {{0 1 outputs_8_ap_vld R 0 "Control signal outputs_8_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x358 outputs_9 R 0x0 "Data signal of outputs_9" {{0 32 outputs_9 R 0 "Bit 31 to 0 Data signal of outputs_9"}}} {0x35c outputs_9_ctrl R 0x0 "Control signal of outputs_9" {{0 1 outputs_9_ap_vld R 0 "Control signal outputs_9_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x360 outputs_10 R 0x0 "Data signal of outputs_10" {{0 32 outputs_10 R 0 "Bit 31 to 0 Data signal of outputs_10"}}} {0x364 outputs_10_ctrl R 0x0 "Control signal of outputs_10" {{0 1 outputs_10_ap_vld R 0 "Control signal outputs_10_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x368 outputs_11 R 0x0 "Data signal of outputs_11" {{0 32 outputs_11 R 0 "Bit 31 to 0 Data signal of outputs_11"}}} {0x36c outputs_11_ctrl R 0x0 "Control signal of outputs_11" {{0 1 outputs_11_ap_vld R 0 "Control signal outputs_11_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x370 outputs_12 R 0x0 "Data signal of outputs_12" {{0 32 outputs_12 R 0 "Bit 31 to 0 Data signal of outputs_12"}}} {0x374 outputs_12_ctrl R 0x0 "Control signal of outputs_12" {{0 1 outputs_12_ap_vld R 0 "Control signal outputs_12_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x378 outputs_13 R 0x0 "Data signal of outputs_13" {{0 32 outputs_13 R 0 "Bit 31 to 0 Data signal of outputs_13"}}} {0x37c outputs_13_ctrl R 0x0 "Control signal of outputs_13" {{0 1 outputs_13_ap_vld R 0 "Control signal outputs_13_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x380 outputs_14 R 0x0 "Data signal of outputs_14" {{0 32 outputs_14 R 0 "Bit 31 to 0 Data signal of outputs_14"}}} {0x384 outputs_14_ctrl R 0x0 "Control signal of outputs_14" {{0 1 outputs_14_ap_vld R 0 "Control signal outputs_14_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x388 outputs_15 R 0x0 "Data signal of outputs_15" {{0 32 outputs_15 R 0 "Bit 31 to 0 Data signal of outputs_15"}}} {0x38c outputs_15_ctrl R 0x0 "Control signal of outputs_15" {{0 1 outputs_15_ap_vld R 0 "Control signal outputs_15_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x390 outputs_16 R 0x0 "Data signal of outputs_16" {{0 32 outputs_16 R 0 "Bit 31 to 0 Data signal of outputs_16"}}} {0x394 outputs_16_ctrl R 0x0 "Control signal of outputs_16" {{0 1 outputs_16_ap_vld R 0 "Control signal outputs_16_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x398 outputs_17 R 0x0 "Data signal of outputs_17" {{0 32 outputs_17 R 0 "Bit 31 to 0 Data signal of outputs_17"}}} {0x39c outputs_17_ctrl R 0x0 "Control signal of outputs_17" {{0 1 outputs_17_ap_vld R 0 "Control signal outputs_17_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3a0 outputs_18 R 0x0 "Data signal of outputs_18" {{0 32 outputs_18 R 0 "Bit 31 to 0 Data signal of outputs_18"}}} {0x3a4 outputs_18_ctrl R 0x0 "Control signal of outputs_18" {{0 1 outputs_18_ap_vld R 0 "Control signal outputs_18_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3a8 outputs_19 R 0x0 "Data signal of outputs_19" {{0 32 outputs_19 R 0 "Bit 31 to 0 Data signal of outputs_19"}}} {0x3ac outputs_19_ctrl R 0x0 "Control signal of outputs_19" {{0 1 outputs_19_ap_vld R 0 "Control signal outputs_19_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3b0 outputs_20 R 0x0 "Data signal of outputs_20" {{0 32 outputs_20 R 0 "Bit 31 to 0 Data signal of outputs_20"}}} {0x3b4 outputs_20_ctrl R 0x0 "Control signal of outputs_20" {{0 1 outputs_20_ap_vld R 0 "Control signal outputs_20_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3b8 outputs_21 R 0x0 "Data signal of outputs_21" {{0 32 outputs_21 R 0 "Bit 31 to 0 Data signal of outputs_21"}}} {0x3bc outputs_21_ctrl R 0x0 "Control signal of outputs_21" {{0 1 outputs_21_ap_vld R 0 "Control signal outputs_21_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c0 outputs_22 R 0x0 "Data signal of outputs_22" {{0 32 outputs_22 R 0 "Bit 31 to 0 Data signal of outputs_22"}}} {0x3c4 outputs_22_ctrl R 0x0 "Control signal of outputs_22" {{0 1 outputs_22_ap_vld R 0 "Control signal outputs_22_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c8 outputs_23 R 0x0 "Data signal of outputs_23" {{0 32 outputs_23 R 0 "Bit 31 to 0 Data signal of outputs_23"}}} {0x3cc outputs_23_ctrl R 0x0 "Control signal of outputs_23" {{0 1 outputs_23_ap_vld R 0 "Control signal outputs_23_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "inputs_0 {base_address 16 range 16} inputs_1 {base_address 32 range 16} inputs_2 {base_address 48 range 16} inputs_3 {base_address 64 range 16} inputs_4 {base_address 80 range 16} inputs_5 {base_address 96 range 16} inputs_6 {base_address 112 range 16} inputs_7 {base_address 128 range 16} inputs_8 {base_address 144 range 16} inputs_9 {base_address 160 range 16} inputs_10 {base_address 176 range 16} inputs_11 {base_address 192 range 16} inputs_12 {base_address 208 range 16} inputs_13 {base_address 224 range 16} inputs_14 {base_address 240 range 16} inputs_15 {base_address 256 range 16} inputs_16 {base_address 272 range 16} inputs_17 {base_address 288 range 16} inputs_18 {base_address 304 range 16} inputs_19 {base_address 320 range 16} inputs_20 {base_address 336 range 16} inputs_21 {base_address 352 range 16} inputs_22 {base_address 368 range 16} inputs_23 {base_address 384 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
