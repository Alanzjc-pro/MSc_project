...
set Library     "hls"
set IPName      "estimate_ISI_encode"
set Version     "1.0"
set DisplayName "Estimate_isi_encode"
set Revision    "2108121204"
...
set sdx_kernel_name "estimate_ISI_encode"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/e2/Documents/ISI_MUL_EN/unroll_12_pipeline"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_ISI_encode_ISIquan_0_V
...
## Variables
set Top "estimate_ISI_encode"
set TopNoPrefix "estimate_ISI_encode"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x320 output_0 R 0x0 "Data signal of output_0" {{0 32 output_0 R 0 "Bit 31 to 0 Data signal of output_0"}}} {0x324 output_0_ctrl R 0x0 "Control signal of output_0" {{0 1 output_0_ap_vld R 0 "Control signal output_0_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x328 output_1 R 0x0 "Data signal of output_1" {{0 32 output_1 R 0 "Bit 31 to 0 Data signal of output_1"}}} {0x32c output_1_ctrl R 0x0 "Control signal of output_1" {{0 1 output_1_ap_vld R 0 "Control signal output_1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x330 output_2 R 0x0 "Data signal of output_2" {{0 32 output_2 R 0 "Bit 31 to 0 Data signal of output_2"}}} {0x334 output_2_ctrl R 0x0 "Control signal of output_2" {{0 1 output_2_ap_vld R 0 "Control signal output_2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x338 output_3 R 0x0 "Data signal of output_3" {{0 32 output_3 R 0 "Bit 31 to 0 Data signal of output_3"}}} {0x33c output_3_ctrl R 0x0 "Control signal of output_3" {{0 1 output_3_ap_vld R 0 "Control signal output_3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x340 output_4 R 0x0 "Data signal of output_4" {{0 32 output_4 R 0 "Bit 31 to 0 Data signal of output_4"}}} {0x344 output_4_ctrl R 0x0 "Control signal of output_4" {{0 1 output_4_ap_vld R 0 "Control signal output_4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x348 output_5 R 0x0 "Data signal of output_5" {{0 32 output_5 R 0 "Bit 31 to 0 Data signal of output_5"}}} {0x34c output_5_ctrl R 0x0 "Control signal of output_5" {{0 1 output_5_ap_vld R 0 "Control signal output_5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x350 output_6 R 0x0 "Data signal of output_6" {{0 32 output_6 R 0 "Bit 31 to 0 Data signal of output_6"}}} {0x354 output_6_ctrl R 0x0 "Control signal of output_6" {{0 1 output_6_ap_vld R 0 "Control signal output_6_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x358 output_7 R 0x0 "Data signal of output_7" {{0 32 output_7 R 0 "Bit 31 to 0 Data signal of output_7"}}} {0x35c output_7_ctrl R 0x0 "Control signal of output_7" {{0 1 output_7_ap_vld R 0 "Control signal output_7_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x360 output_8 R 0x0 "Data signal of output_8" {{0 32 output_8 R 0 "Bit 31 to 0 Data signal of output_8"}}} {0x364 output_8_ctrl R 0x0 "Control signal of output_8" {{0 1 output_8_ap_vld R 0 "Control signal output_8_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x368 output_9 R 0x0 "Data signal of output_9" {{0 32 output_9 R 0 "Bit 31 to 0 Data signal of output_9"}}} {0x36c output_9_ctrl R 0x0 "Control signal of output_9" {{0 1 output_9_ap_vld R 0 "Control signal output_9_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x370 output_10 R 0x0 "Data signal of output_10" {{0 32 output_10 R 0 "Bit 31 to 0 Data signal of output_10"}}} {0x374 output_10_ctrl R 0x0 "Control signal of output_10" {{0 1 output_10_ap_vld R 0 "Control signal output_10_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x378 output_11 R 0x0 "Data signal of output_11" {{0 32 output_11 R 0 "Bit 31 to 0 Data signal of output_11"}}} {0x37c output_11_ctrl R 0x0 "Control signal of output_11" {{0 1 output_11_ap_vld R 0 "Control signal output_11_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "inputs_0 {base_address 32 range 32} inputs_1 {base_address 64 range 32} inputs_2 {base_address 96 range 32} inputs_3 {base_address 128 range 32} inputs_4 {base_address 160 range 32} inputs_5 {base_address 192 range 32} inputs_6 {base_address 224 range 32} inputs_7 {base_address 256 range 32} inputs_8 {base_address 288 range 32} inputs_9 {base_address 320 range 32} inputs_10 {base_address 352 range 32} inputs_11 {base_address 384 range 32} rem_0 {base_address 416 range 32} rem_1 {base_address 448 range 32} rem_2 {base_address 480 range 32} rem_3 {base_address 512 range 32} rem_4 {base_address 544 range 32} rem_5 {base_address 576 range 32} rem_6 {base_address 608 range 32} rem_7 {base_address 640 range 32} rem_8 {base_address 672 range 32} rem_9 {base_address 704 range 32} rem_10 {base_address 736 range 32} rem_11 {base_address 768 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
