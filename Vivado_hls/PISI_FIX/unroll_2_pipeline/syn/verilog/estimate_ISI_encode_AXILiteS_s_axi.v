...
localparam
    ...
    ADDR_IER           = 11'h008,
    ADDR_ISR           = 11'h00c,
    ADDR_INPUTS_0_BASE = 11'h100,
    ADDR_INPUTS_0_HIGH = 11'h1ff,
    ADDR_INPUTS_1_BASE = 11'h200,
    ADDR_INPUTS_1_HIGH = 11'h2ff,
    ADDR_REM_0_BASE    = 11'h300,
    ADDR_REM_0_HIGH    = 11'h3ff,
    ADDR_REM_1_BASE    = 11'h400,
    ADDR_REM_1_HIGH    = 11'h4ff,
    ADDR_OUTPUT_0_BASE = 11'h500,
    ADDR_OUTPUT_0_HIGH = 11'h51f,
    ADDR_OUTPUT_1_BASE = 11'h520,
    ADDR_OUTPUT_1_HIGH = 11'h53f,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
assign RVALID  = (rstate == RDDATA) & !int_inputs_0_read & !int_inputs_1_read & !int_rem_0_read & !int_rem_1_read & !int_output_0_read & !int_output_1_read;
...
assign int_rem_0_address1    = ar_hs? raddr[7:2] : waddr[7:2];
...
assign int_rem_1_address1    = ar_hs? raddr[7:2] : waddr[7:2];
...
assign int_output_0_address1 = ar_hs? raddr[4:2] : waddr[4:2];
...
assign int_output_1_address1 = ar_hs? raddr[4:2] : waddr[4:2];
