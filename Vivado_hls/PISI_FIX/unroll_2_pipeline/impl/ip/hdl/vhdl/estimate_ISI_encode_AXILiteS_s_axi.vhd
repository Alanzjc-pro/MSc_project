...
architecture behave of estimate_ISI_encode_AXILiteS_s_axi is
    ...
    constant ADDR_REM_0_BASE    : INTEGER := 16#300#;
    constant ADDR_REM_0_HIGH    : INTEGER := 16#3ff#;
    constant ADDR_REM_1_BASE    : INTEGER := 16#400#;
    constant ADDR_REM_1_HIGH    : INTEGER := 16#4ff#;
    constant ADDR_OUTPUT_0_BASE : INTEGER := 16#500#;
    constant ADDR_OUTPUT_0_HIGH : INTEGER := 16#51f#;
    constant ADDR_OUTPUT_1_BASE : INTEGER := 16#520#;
    constant ADDR_OUTPUT_1_HIGH : INTEGER := 16#53f#;
    ...
    signal int_rem_0_address0  : UNSIGNED(5 downto 0);
    ...
    signal int_rem_0_address1  : UNSIGNED(5 downto 0);
    ...
    signal int_rem_1_address0  : UNSIGNED(5 downto 0);
    ...
    signal int_rem_1_address1  : UNSIGNED(5 downto 0);
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_inputs_0_read = '0') and (int_inputs_1_read = '0') and (int_rem_0_read = '0') and (int_rem_1_read = '0') and (int_output_0_read = '0') and (int_output_1_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_rem_0_address1   <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_rem_1_address1   <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_output_0_address1 <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
    ...
    int_output_1_address1 <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
