...
architecture behave of estimate_ISI_encode_AXILiteS_s_axi is
    ...
    constant ADDR_REM_0_BASE    : INTEGER := 16#240#;
    constant ADDR_REM_0_HIGH    : INTEGER := 16#27f#;
    constant ADDR_REM_1_BASE    : INTEGER := 16#280#;
    constant ADDR_REM_1_HIGH    : INTEGER := 16#2bf#;
    constant ADDR_REM_2_BASE    : INTEGER := 16#2c0#;
    constant ADDR_REM_2_HIGH    : INTEGER := 16#2ff#;
    constant ADDR_REM_3_BASE    : INTEGER := 16#300#;
    constant ADDR_REM_3_HIGH    : INTEGER := 16#33f#;
    constant ADDR_REM_4_BASE    : INTEGER := 16#340#;
    constant ADDR_REM_4_HIGH    : INTEGER := 16#37f#;
    constant ADDR_REM_5_BASE    : INTEGER := 16#380#;
    constant ADDR_REM_5_HIGH    : INTEGER := 16#3bf#;
    constant ADDR_REM_6_BASE    : INTEGER := 16#3c0#;
    constant ADDR_REM_6_HIGH    : INTEGER := 16#3ff#;
    constant ADDR_REM_7_BASE    : INTEGER := 16#400#;
    constant ADDR_REM_7_HIGH    : INTEGER := 16#43f#;
    constant ADDR_OUTPUT_0_BASE : INTEGER := 16#440#;
    constant ADDR_OUTPUT_0_HIGH : INTEGER := 16#447#;
    constant ADDR_OUTPUT_1_BASE : INTEGER := 16#448#;
    constant ADDR_OUTPUT_1_HIGH : INTEGER := 16#44f#;
    constant ADDR_OUTPUT_2_BASE : INTEGER := 16#450#;
    constant ADDR_OUTPUT_2_HIGH : INTEGER := 16#457#;
    constant ADDR_OUTPUT_3_BASE : INTEGER := 16#458#;
    constant ADDR_OUTPUT_3_HIGH : INTEGER := 16#45f#;
    constant ADDR_OUTPUT_4_BASE : INTEGER := 16#460#;
    constant ADDR_OUTPUT_4_HIGH : INTEGER := 16#467#;
    constant ADDR_OUTPUT_5_BASE : INTEGER := 16#468#;
    constant ADDR_OUTPUT_5_HIGH : INTEGER := 16#46f#;
    constant ADDR_OUTPUT_6_BASE : INTEGER := 16#470#;
    constant ADDR_OUTPUT_6_HIGH : INTEGER := 16#477#;
    constant ADDR_OUTPUT_7_BASE : INTEGER := 16#478#;
    constant ADDR_OUTPUT_7_HIGH : INTEGER := 16#47f#;
    ...
    signal int_rem_0_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_0_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_1_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_1_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_2_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_2_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_3_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_3_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_4_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_4_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_5_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_5_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_6_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_6_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_7_address0  : UNSIGNED(3 downto 0);
    ...
    signal int_rem_7_address1  : UNSIGNED(3 downto 0);
    ...
    signal int_output_0_address0 : UNSIGNED(0 downto 0);
    ...
    signal int_output_0_address1 : UNSIGNED(0 downto 0);
    ...
    signal int_output_1_address0 : UNSIGNED(0 downto 0);
    ...
    signal int_output_1_address1 : UNSIGNED(0 downto 0);
    ...
    signal int_output_2_address0 : UNSIGNED(0 downto 0);
    ...
    signal int_output_2_address1 : UNSIGNED(0 downto 0);
    ...
    signal int_output_3_address0 : UNSIGNED(0 downto 0);
    ...
    signal int_output_3_address1 : UNSIGNED(0 downto 0);
    ...
    signal int_output_4_address0 : UNSIGNED(0 downto 0);
    signal int_output_4_ce0    : STD_LOGIC;
    signal int_output_4_we0    : STD_LOGIC;
    signal int_output_4_be0    : UNSIGNED(3 downto 0);
    signal int_output_4_d0     : UNSIGNED(31 downto 0);
    signal int_output_4_q0     : UNSIGNED(31 downto 0);
    signal int_output_4_address1 : UNSIGNED(0 downto 0);
    signal int_output_4_ce1    : STD_LOGIC;
    signal int_output_4_we1    : STD_LOGIC;
    signal int_output_4_be1    : UNSIGNED(3 downto 0);
    signal int_output_4_d1     : UNSIGNED(31 downto 0);
    signal int_output_4_q1     : UNSIGNED(31 downto 0);
    signal int_output_4_read   : STD_LOGIC;
    signal int_output_4_write  : STD_LOGIC;
    signal int_output_5_address0 : UNSIGNED(0 downto 0);
    signal int_output_5_ce0    : STD_LOGIC;
    signal int_output_5_we0    : STD_LOGIC;
    signal int_output_5_be0    : UNSIGNED(3 downto 0);
    signal int_output_5_d0     : UNSIGNED(31 downto 0);
    signal int_output_5_q0     : UNSIGNED(31 downto 0);
    signal int_output_5_address1 : UNSIGNED(0 downto 0);
    signal int_output_5_ce1    : STD_LOGIC;
    signal int_output_5_we1    : STD_LOGIC;
    signal int_output_5_be1    : UNSIGNED(3 downto 0);
    signal int_output_5_d1     : UNSIGNED(31 downto 0);
    signal int_output_5_q1     : UNSIGNED(31 downto 0);
    signal int_output_5_read   : STD_LOGIC;
    signal int_output_5_write  : STD_LOGIC;
    signal int_output_6_address0 : UNSIGNED(0 downto 0);
    signal int_output_6_ce0    : STD_LOGIC;
    signal int_output_6_we0    : STD_LOGIC;
    signal int_output_6_be0    : UNSIGNED(3 downto 0);
    signal int_output_6_d0     : UNSIGNED(31 downto 0);
    signal int_output_6_q0     : UNSIGNED(31 downto 0);
    signal int_output_6_address1 : UNSIGNED(0 downto 0);
    signal int_output_6_ce1    : STD_LOGIC;
    signal int_output_6_we1    : STD_LOGIC;
    signal int_output_6_be1    : UNSIGNED(3 downto 0);
    signal int_output_6_d1     : UNSIGNED(31 downto 0);
    signal int_output_6_q1     : UNSIGNED(31 downto 0);
    signal int_output_6_read   : STD_LOGIC;
    signal int_output_6_write  : STD_LOGIC;
    signal int_output_7_address0 : UNSIGNED(0 downto 0);
    signal int_output_7_ce0    : STD_LOGIC;
    signal int_output_7_we0    : STD_LOGIC;
    signal int_output_7_be0    : UNSIGNED(3 downto 0);
    signal int_output_7_d0     : UNSIGNED(31 downto 0);
    signal int_output_7_q0     : UNSIGNED(31 downto 0);
    signal int_output_7_address1 : UNSIGNED(0 downto 0);
    signal int_output_7_ce1    : STD_LOGIC;
    signal int_output_7_we1    : STD_LOGIC;
    signal int_output_7_be1    : UNSIGNED(3 downto 0);
    signal int_output_7_d1     : UNSIGNED(31 downto 0);
    signal int_output_7_q1     : UNSIGNED(31 downto 0);
...
port map (
     ...
     q1       => int_output_3_q1);
-- int_output_4
int_output_4 : estimate_ISI_encode_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
port map (
     ...
     we0      => int_output_4_we0,
     be0      => int_output_4_be0,
     d0       => int_output_4_d0,
     q0       => int_output_4_q0,
     clk1     => ACLK,
     address1 => int_output_4_address1,
     ce1      => int_output_4_ce1,
     we1      => int_output_4_we1,
     be1      => int_output_4_be1,
     d1       => int_output_4_d1,
     q1       => int_output_4_q1);
-- int_output_5
int_output_5 : estimate_ISI_encode_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
port map (
     ...
     we0      => int_output_5_we0,
     be0      => int_output_5_be0,
     d0       => int_output_5_d0,
     q0       => int_output_5_q0,
     clk1     => ACLK,
     address1 => int_output_5_address1,
     ce1      => int_output_5_ce1,
     we1      => int_output_5_we1,
     be1      => int_output_5_be1,
     d1       => int_output_5_d1,
     q1       => int_output_5_q1);
-- int_output_6
int_output_6 : estimate_ISI_encode_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
port map (
     ...
     we0      => int_output_6_we0,
     be0      => int_output_6_be0,
     d0       => int_output_6_d0,
     q0       => int_output_6_q0,
     clk1     => ACLK,
     address1 => int_output_6_address1,
     ce1      => int_output_6_ce1,
     we1      => int_output_6_we1,
     be1      => int_output_6_be1,
     d1       => int_output_6_d1,
     q1       => int_output_6_q1);
-- int_output_7
int_output_7 : estimate_ISI_encode_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
port map (
     ...
     we0      => int_output_7_we0,
     be0      => int_output_7_be0,
     d0       => int_output_7_d0,
     q0       => int_output_7_q0,
     clk1     => ACLK,
     address1 => int_output_7_address1,
     ce1      => int_output_7_ce1,
     we1      => int_output_7_we1,
     be1      => int_output_7_be1,
     d1       => int_output_7_d1,
     q1       => int_output_7_q1);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    rdata_data <= int_output_4_q1;
                elsif (int_output_5_read = '1') then
                    rdata_data <= int_output_5_q1;
                elsif (int_output_6_read = '1') then
                    rdata_data <= int_output_6_q1;
                elsif (int_output_7_read = '1') then
                    rdata_data <= int_output_7_q1;
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    ...
    int_rem_0_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_1_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_2_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_3_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_4_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_5_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_6_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_rem_7_address1   <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_output_0_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    ...
    int_output_1_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    ...
    int_output_2_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    ...
    int_output_3_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    ...
    int_output_4_we0     <= output_4_we0;
    int_output_4_be0     <= (others => output_4_we0);
    int_output_4_d0      <= RESIZE(UNSIGNED(output_4_d0), 32);
    int_output_4_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    int_output_4_ce1     <= '1' when ar_hs = '1' or (int_output_4_write = '1' and WVALID  = '1') else '0';
    int_output_4_we1     <= '1' when int_output_4_write = '1' and WVALID = '1' else '0';
    int_output_4_be1     <= UNSIGNED(WSTRB);
    int_output_4_d1      <= UNSIGNED(WDATA);
    -- output_5
    int_output_5_address0 <= UNSIGNED(output_5_address0);
    int_output_5_ce0     <= output_5_ce0;
    int_output_5_we0     <= output_5_we0;
    int_output_5_be0     <= (others => output_5_we0);
    int_output_5_d0      <= RESIZE(UNSIGNED(output_5_d0), 32);
    int_output_5_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    int_output_5_ce1     <= '1' when ar_hs = '1' or (int_output_5_write = '1' and WVALID  = '1') else '0';
    int_output_5_we1     <= '1' when int_output_5_write = '1' and WVALID = '1' else '0';
    int_output_5_be1     <= UNSIGNED(WSTRB);
    int_output_5_d1      <= UNSIGNED(WDATA);
    -- output_6
    int_output_6_address0 <= UNSIGNED(output_6_address0);
    int_output_6_ce0     <= output_6_ce0;
    int_output_6_we0     <= output_6_we0;
    int_output_6_be0     <= (others => output_6_we0);
    int_output_6_d0      <= RESIZE(UNSIGNED(output_6_d0), 32);
    int_output_6_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    int_output_6_ce1     <= '1' when ar_hs = '1' or (int_output_6_write = '1' and WVALID  = '1') else '0';
    int_output_6_we1     <= '1' when int_output_6_write = '1' and WVALID = '1' else '0';
    int_output_6_be1     <= UNSIGNED(WSTRB);
    int_output_6_d1      <= UNSIGNED(WDATA);
    -- output_7
    int_output_7_address0 <= UNSIGNED(output_7_address0);
    int_output_7_ce0     <= output_7_ce0;
    int_output_7_we0     <= output_7_we0;
    int_output_7_be0     <= (others => output_7_we0);
    int_output_7_d0      <= RESIZE(UNSIGNED(output_7_d0), 32);
    int_output_7_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
    int_output_7_ce1     <= '1' when ar_hs = '1' or (int_output_7_write = '1' and WVALID  = '1') else '0';
    int_output_7_we1     <= '1' when int_output_7_write = '1' and WVALID = '1' else '0';
    int_output_7_be1     <= UNSIGNED(WSTRB);
    int_output_7_d1      <= UNSIGNED(WDATA);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_4_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_OUTPUT_4_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_OUTPUT_4_HIGH) then
                    int_output_4_write <= '1';
                elsif (WVALID = '1') then
                    int_output_4_write <= '0';
                end if;
            end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_5_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_OUTPUT_5_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_OUTPUT_5_HIGH) then
                    int_output_5_write <= '1';
                elsif (WVALID = '1') then
                    int_output_5_write <= '0';
                end if;
            end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_6_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_OUTPUT_6_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_OUTPUT_6_HIGH) then
                    int_output_6_write <= '1';
                elsif (WVALID = '1') then
                    int_output_6_write <= '0';
                end if;
            end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_7_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_OUTPUT_7_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_OUTPUT_7_HIGH) then
                    int_output_7_write <= '1';
                elsif (WVALID = '1') then
                    int_output_7_write <= '0';
                end if;
            end if;
