...
set solution_dir "/home/e2/Documents/ISI_MUL_EN/unroll_8_pipeline"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_ISI_encode_urem_7ns_5ns_5_11_1
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "inputs_0 {base_address 64 range 64} inputs_1 {base_address 128 range 64} inputs_2 {base_address 192 range 64} inputs_3 {base_address 256 range 64} inputs_4 {base_address 320 range 64} inputs_5 {base_address 384 range 64} inputs_6 {base_address 448 range 64} inputs_7 {base_address 512 range 64} rem_0 {base_address 576 range 64} rem_1 {base_address 640 range 64} rem_2 {base_address 704 range 64} rem_3 {base_address 768 range 64} rem_4 {base_address 832 range 64} rem_5 {base_address 896 range 64} rem_6 {base_address 960 range 64} rem_7 {base_address 1024 range 64} output_0 {base_address 1088 range 8} output_1 {base_address 1096 range 8} output_2 {base_address 1104 range 8} output_3 {base_address 1112 range 8} output_4 {base_address 1120 range 8} output_5 {base_address 1128 range 8} output_6 {base_address 1136 range 8} output_7 {base_address 1144 range 8}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
