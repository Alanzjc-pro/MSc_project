...
set_directive_unroll -factor 4 "estimate_ISI_encode/estimate_ISI"
set_directive_array_partition -type cyclic -factor 4 -dim 1 "estimate_ISI_encode" inputs
set_directive_array_partition -type cyclic -factor 4 -dim 1 "estimate_ISI_encode" rem
set_directive_array_partition -type cyclic -factor 4 -dim 1 "estimate_ISI_encode" output
