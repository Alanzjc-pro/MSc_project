...
// ==============================================================
#ifndef __estimate_FR_dcmp_64ns_64ns_1_2_1__HH__
#define __estimate_FR_dcmp_64ns_64ns_1_2_1__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(estimate_FR_dcmp_64ns_64ns_1_2_1) {
    ...
    SC_CTOR(estimate_FR_dcmp_64ns_64ns_1_2_1):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
