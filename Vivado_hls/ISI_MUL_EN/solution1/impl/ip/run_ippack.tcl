...
set solution_dir "/home/e2/Documents/ISI_MUL_EN/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {estimate_ISI_encode_ISIquan_V
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "inputs {base_address 512 range 512} rem_r {base_address 1024 range 512} output_r {base_address 1536 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 350 II x}
